        ...
        <div class="row tm-mb-74 tm-row-1640">            
            ...
            <div class="col-lg-7 col-md-6 col-12">
                <div class="tm-about-img-text">
                    ...
                    <p>
                        We offer transparent and affordable pricing options for our digital menu, without any hidden fees or complicated contracts. Our goal is to provide a straightforward and cost-effective solution that meets the needs of your business, allowing you to focus on delivering exceptional digital experiences to your customers.</p>
                </div>                
            </div>
        </div>
        <div class="row tm-mb-50">
            ...
            <div class="col-md-6 col-12">
                <div class="tm-about-2-col">
                    ...
                    <p class="mb-4">
                        Having a better admin control over the QR code menu system provides restaurant owners with greater flexibility and convenience. You can easily update and modify their menus in real-time
                    </p>
                    <p>
                        Manage restaurant information: Easily update your restaurant logo, name and support multi language.
